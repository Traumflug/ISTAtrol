 ...
 *
 * Modified for ISTAtrol by
 * (C) 2016 Markus "Traumflug" Hitter <mah@jump-ing.de>
 */
 ...
 */
#define USB_CFG_VENDOR_NAME     'R', 'e', 'p', 'R', 'a', 'p', ' ', 'D', 'I', 'Y'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'I', 'S', 'T', 'A', 't', 'r', 'o', 'l'
